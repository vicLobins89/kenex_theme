...
<div class="message alt cf">
	<p class="desc">
		<strong><?php esc_html_e( 'Do you know the product codes for the items you need?', 'woocommerce' ); ?></strong><br>
		<?php esc_html_e( 'Create a new quote from product codes', 'woocommerce' ); ?>
	</p>
	<a class="woocommerce-button button" href="<?php echo home_url('/quick-quote'); ?>">
		<?php esc_html_e( 'Quick quote', 'woocommerce' ); ?>
	</a>
</div>
