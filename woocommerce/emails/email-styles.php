...
#body_content_inner {
    ...
    background-image: linear-gradient(to top, #91005a, #c4007a);
}
...
#body_content_inner h1 {
    font-weight: bold;
    background: url(../wp-content/themes/kenex_theme/library/images/flair-white.png) no-repeat left bottom;
